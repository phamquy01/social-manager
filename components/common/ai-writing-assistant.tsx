...
export function AIWritingAssistant({ onContentGenerate }: AIWritingAssistantProps) {
  ...
  const contentTemplates = [
    {
      ...
      template: "🔥 Xu hướng hot nhất hiện nay! {topic} đang được mọi người quan tâm. Bạn đã biết chưa? #trending #hot",
    },
    {
            ...
            {isGenerating && (
              <div className="text-center py-4">
                <div className="inline-flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600">Đang tạo nội dung...</span>
                </div>
              </div>
            )}
          </div>
